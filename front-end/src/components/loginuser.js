...
const LoginUser = ({ onSignupClick, onForgotPasswordClick, onLogoClick }) => {
      ...
      <div className="col-md-5 position-relative">
        <div className="form-box login position-relative">
          ...
          <form onSubmit={handleSubmit}>
            ...
            />
            <p className="forgot"><a href="#" onClick={onForgotPasswordClick}>Forgot Password?</a></p>
          ...
          <p>Didn’t have an account? <a href="#" onClick={onSignupClick} className="signup-button">Sign Up</a></p>
        </div>
      </div>
    </section>
  );
